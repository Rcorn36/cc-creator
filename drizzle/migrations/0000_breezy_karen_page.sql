CREATE TYPE "public"."tier" AS ENUM('ccsocial', 'ccsocialGamer', 'ccsocialCreator', 'ccsocialPro');--> statement-breakpoint
...
CREATE TABLE "country_groups" (
	...
	"name" text NOT NULL,
	"recommended_discounnt_percentage" real,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "product_customizations" (
	...
	"class_prefix" text,
	"product_id" uuid NOT NULL,
	"location_message" text DEFAULT 'Hey I see you''re from <b>{country}</b>' NOT NULL,
	"background_color" text DEFAULT 'hsl(193, 82% 31%)' NOT NULL,
	"text_color" text DEFAULT 'hsl(193, 82%, 31%)' NOT NULL,
