          ...
          <div className="flex flex-col gap-4 text-center md:text-left">
            ...
            <nav className="ml-2 mr-3">
              <ul className="flex flex-row gap-4 justify-center items-center">
                ...
                <li>
                  <Link href="#employment" className="text-blue-500 hover:underline">
            ...
            <div className="text-center">
              <p>Ultimately I am creating this site for potential employers, clients, and business partners to get to know my professional background as well as to launch web applications that are part of my graduate project for my master&apos;s degree program.</p>
